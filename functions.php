...
// Formulario  de busqueda en single
...
function espacio_para_descripci√≥n_HTML() {
	echo'
...
add_action('woocommerce_after_single_product_summary', 'espacio_para_descripci√≥n_HTML', 5);
...
/**
 * Oculta precios y boton "compra" de WooCommerce en la p®¢gina de tienda
*/ 
