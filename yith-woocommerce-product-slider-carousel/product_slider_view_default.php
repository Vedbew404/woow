...
<div class="woocommerce">
    ...
    <div class="ywcps-wrapper" <?php echo $data_attributes; //phpcs:ignore WordPress.Security.EscapeOutput ?>>
        ...
        <div class="ywcps-nav">
            <div id="nav_prev_def_free" class="ywcps-nav-prev">
                <span id="default_prev">
                    <img src="http://woowcolombia.test/wp-content/uploads/2021/06/izquierda.png" alt="">
                </span>
            </div>
            <div id="nav_next_def_free" class="ywcps-nav-next">
                <span id="default_next">
                    <img src="http://woowcolombia.test/wp-content/uploads/2021/06/derecha.png" alt="">
                </span>
            </div>
        </div>
    </div>
